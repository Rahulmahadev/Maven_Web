node{
  ...
  nexusPublisher nexusInstanceId: '1234', nexusRepositoryId: 'maven-releases', packages: [[$class: 'MavenPackage', mavenAssetList: [[classifier: '', extension: '', filePath: 'target/my-app-web.war']], mavenCoordinate: [artifactId: 'my-app-web', groupId: 'com.mycompany.app', packaging: 'war', version: '11.7']]]
